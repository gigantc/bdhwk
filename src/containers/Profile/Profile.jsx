  ...
  return (
    <>
      <section className="profile" ref={textBlock}>
          ...
          From Fortune 500 giants to scrappy startups, I've helped teams bring ambitious ideas to life through smart architecture, modern JavaScript frameworks, and UX led design systems. 
          <br /><br />
